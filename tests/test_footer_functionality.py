...
def test_footer_visibility(setup_browser, link_to):
...
@allure.story("Проверка отображения заголовков нижнего меню")
def test_footer_link_to_home(setup_browser, link_to):
    with allure.step("Запуск браузера и открытие страницы"):
        page = setup_browser
        page.goto(link_to)
        page.wait_for_timeout(2000)
...
@allure.story("Проверка отображения заголовков нижнего меню")
def test_footer_link_to_menu(setup_browser, link_to):
    with allure.step("Запуск браузера и открытие страницы"):
        page = setup_browser
        page.goto(link_to)
        page.wait_for_timeout(2000)
...
@allure.story("Проверка отображения заголовков нижнего меню")
def test_footer_link_to_products(setup_browser, link_to):
    with allure.step("Запуск браузера и открытие страницы"):
        page = setup_browser
        page.goto(link_to)
        page.wait_for_timeout(2000)
...
@allure.story("Проверка отображения заголовков нижнего меню")
def test_footer_link_to_info(setup_browser, link_to):
    with allure.step("Запуск браузера и открытие страницы"):
        page = setup_browser
        page.goto(link_to)
        page.wait_for_timeout(2000)
...
@allure.story("Проверка отображения заголовков нижнего меню")
def test_footer_link_to_contacts(setup_browser, link_to):
    with allure.step("Запуск браузера и открытие страницы"):
        page = setup_browser
        page.goto(link_to)
        page.wait_for_timeout(2000)
