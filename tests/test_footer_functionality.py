...
from tests.project_selectors.locators import SelectorsFooter
from tests.project_selectors.locators import SelectorsProductsPage
from tests.project_selectors.locators import SelectorsAboutPage
